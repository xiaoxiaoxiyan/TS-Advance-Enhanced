...
build_time_vars = {'ABIFLAGS': '',
 ...
 'AR': '/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ar',
 'ARFLAGS': 'rcs',
 'BASECFLAGS': '',
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/root/edl/android-out/edl-android-arm64-full-ossl111/bin',
 'BINLIBDEST': '/root/edl/android-out/edl-android-arm64-full-ossl111/lib/python3.11',
 'BLDLIBRARY': '-L. -lpython3.11',
 'BLDSHARED': '/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang '
              '-shared '
              '--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot '
              '-L/root/edl/android-out/edl-android-arm64-full-ossl111/lib '
              '--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot '
              '-L/root/edl/android-out/edl-android-arm64-full-ossl111/lib',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 ...
 'BYTESTR_DEPS': '\\',
 'CC': '/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang',
 'CCSHARED': '',
 'CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall '
           '--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot '
           '-fPIC '
           '--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot '
           '-fPIC',
 ...
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot '
                     '-fPIC',
 'CONFIGURE_CFLAGS_NODIST': '-std=c11 -Werror=implicit-function-declaration '
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '-I/root/edl/android-out/edl-android-arm64-full-ossl111/include',
 'CONFIGURE_LDFLAGS': '--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot '
                      '-L/root/edl/android-out/edl-android-arm64-full-ossl111/lib',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIGURE_LDFLAGS_NOLTO': '',
 'CONFIG_ARGS': "'--host=aarch64-linux-android' '--build=x86_64-pc-linux-gnu' "
                "'--prefix=/root/edl/android-out/edl-android-arm64-full-ossl111' "
                "'--enable-shared' "
                "'--with-openssl=/root/edl/android-out/edl-android-arm64-full-ossl111' "
                "'--with-build-python=/root/edl/android-build-full-ossl111/hostpython/bin/python3' "
                "'--without-ensurepip' 'build_alias=x86_64-pc-linux-gnu' "
                "'host_alias=aarch64-linux-android' "
                "'PKG_CONFIG_LIBDIR=/root/edl/android-out/edl-android-arm64-full-ossl111/lib/pkgconfig' "
                "'CC=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang' "
                "'CFLAGS=--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot "
                "-fPIC' "
                "'LDFLAGS=--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot "
                "-L/root/edl/android-out/edl-android-arm64-full-ossl111/lib' "
                "'CPPFLAGS=-I/root/edl/android-out/edl-android-arm64-full-ossl111/include'",
 'CONFINCLUDEDIR': '/root/edl/android-out/edl-android-arm64-full-ossl111/include',
 'CONFINCLUDEPY': '/root/edl/android-out/edl-android-arm64-full-ossl111/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/root/edl/android-build-full-ossl111/Python-3.11.8/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/root/edl/android-build-full-ossl111/Python-3.11.8/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage '
                            '--title "CPython 3.11 LCOV report [commit $(shell '
                            ')]"',
 'CPPFLAGS': '-I. -I./Include '
             '-I/root/edl/android-out/edl-android-arm64-full-ossl111/include '
             '-I/root/edl/android-out/edl-android-arm64-full-ossl111/include',
 'CXX': '/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang++',
 ...
 'DESTDIRS': '/root/edl/android-out/edl-android-arm64-full-ossl111 '
             '/root/edl/android-out/edl-android-arm64-full-ossl111/lib '
             '/root/edl/android-out/edl-android-arm64-full-ossl111/lib/python3.11 '
             '/root/edl/android-out/edl-android-arm64-full-ossl111/lib/python3.11/lib-dynload',
 'DESTLIB': '/root/edl/android-out/edl-android-arm64-full-ossl111/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/root/edl/android-out/edl-android-arm64-full-ossl111/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'FREEZE_MODULE': '/root/edl/android-build-full-ossl111/hostpython/bin/python3 '
                  './Programs/_freeze_module.py',
 'FREEZE_MODULE_BOOTSTRAP': '/root/edl/android-build-full-ossl111/hostpython/bin/python3 '
                            './Programs/_freeze_module.py',
 ...
 'INCLDIRSTOMAKE': '/root/edl/android-out/edl-android-arm64-full-ossl111/include '
                   '/root/edl/android-out/edl-android-arm64-full-ossl111/include '
                   '/root/edl/android-out/edl-android-arm64-full-ossl111/include/python3.11 '
                   '/root/edl/android-out/edl-android-arm64-full-ossl111/include/python3.11',
 'INCLUDEDIR': '/root/edl/android-out/edl-android-arm64-full-ossl111/include',
 'INCLUDEPY': '/root/edl/android-out/edl-android-arm64-full-ossl111/include/python3.11',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': '/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang++ '
                '-shared',
 'LDFLAGS': '--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot '
            '-L/root/edl/android-out/edl-android-arm64-full-ossl111/lib '
            '--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot '
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': '/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang '
             '-shared '
             '--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot '
             '-L/root/edl/android-out/edl-android-arm64-full-ossl111/lib '
             '--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot '
 ...
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/root/edl/android-out/edl-android-arm64-full-ossl111/lib/python3.11',
 'LIBDIR': '/root/edl/android-out/edl-android-arm64-full-ossl111/lib',
 'LIBEXPAT_A': 'Modules/expat/libexpat.a',
 'LIBEXPAT_CFLAGS': '-I./Modules/expat -DNDEBUG -g -fwrapv -O3 -Wall '
                    '--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot '
                    '-fPIC '
                    '--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot '
                    '-fPIC -std=c11 -Werror=implicit-function-declaration '
                    '-fvisibility=hidden  -I./Include/internal -I. -I./Include '
                    '-I/root/edl/android-out/edl-android-arm64-full-ossl111/include '
                    '-I/root/edl/android-out/edl-android-arm64-full-ossl111/include',
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 'LIBFFI_INCLUDEDIR': '/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot/root/edl/android-out/edl-android-arm64-full-ossl111/include',
 'LIBM': '-lm',
 'LIBMPDEC_A': 'Modules/_decimal/libmpdec/libmpdec.a',
 'LIBMPDEC_CFLAGS': '-I./Modules/_decimal/libmpdec -DCONFIG_64=1 -DANSI=1 '
                    '-DHAVE_UINT128_T=1 -DNDEBUG -g -fwrapv -O3 -Wall '
                    '--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot '
                    '-fPIC '
                    '--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot '
                    '-fPIC -std=c11 -Werror=implicit-function-declaration '
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/root/edl/android-out/edl-android-arm64-full-ossl111/lib/pkgconfig',
 'LIBPL': '/root/edl/android-out/edl-android-arm64-full-ossl111/lib/python3.11/config-3.11',
 ...
 'LIBS': '-ldl  -lpthread',
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': '/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang',
 ...
 'LLVM_PROF_MERGER': '/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-profdata '
                     'merge -output=code.profclangd *.profclangr',
 'LN': 'ln',
 'LOCALMODLIBS': '-ldl -lffi',
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/root/edl/android-out/edl-android-arm64-full-ossl111/lib/python3.11',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': '/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 1,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/root/edl/android-out/edl-android-arm64-full-ossl111/share/man',
 'MKDIR_P': '/usr/bin/mkdir -p',
 'MODBUILT_NAMES': '_ctypes  atexit  faulthandler  posix  _signal  '
 ...
 'MODDISABLED_NAMES': '',
 'MODLIBS': '-ldl -lffi',
 'MODOBJS': 'Modules/_ctypes/_ctypes.o Modules/_ctypes/callbacks.o '
 ...
 'MODULE__HASHLIB_CFLAGS': '-I/root/edl/android-out/edl-android-arm64-full-ossl111/include',
 'MODULE__HASHLIB_DEPS': './Modules/hashlib.h',
 'MODULE__HASHLIB_LDFLAGS': '-L/root/edl/android-out/edl-android-arm64-full-ossl111/lib   '
                            '-lcrypto',
 ...
 'MODULE__LZMA_CFLAGS': '-I/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot/root/edl/android-out/edl-android-arm64-full-ossl111/include',
 'MODULE__LZMA_LDFLAGS': '-L/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot/root/edl/android-out/edl-android-arm64-full-ossl111/lib '
                         '-llzma',
 ...
 'MODULE__SRE_LDFLAGS': '',
 'MODULE__SSL_CFLAGS': '-I/root/edl/android-out/edl-android-arm64-full-ossl111/include',
 ...
 'MODULE__SSL_LDFLAGS': '-L/root/edl/android-out/edl-android-arm64-full-ossl111/lib  '
                        '-lssl -lcrypto',
 ...
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/root/edl/android-out/edl-android-arm64-full-ossl111/include',
 'OPENSSL_LDFLAGS': '-L/root/edl/android-out/edl-android-arm64-full-ossl111/lib',
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/root/edl/android-build-full-ossl111/Python-3.11.8 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/root/edl/android-build-full-ossl111/Python-3.11.8/`cat '
                     'pybuilddir.txt`:)./Lib '
                     '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_ '
                     '/root/edl/android-build-full-ossl111/hostpython/bin/python3',
 'PYTHON_FOR_BUILD_DEPS': '',
 'PYTHON_FOR_FREEZE': '/root/edl/android-build-full-ossl111/hostpython/bin/python3',
 'PYTHON_FOR_REGEN': '',
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 'PY_BUILTIN_HASHLIB_HASHES': '"md5,sha1,sha256,sha512,sha3,blake2"',
 'PY_BUILTIN_MODULE_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall '
                             '--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot '
                             '-fPIC '
                             '--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot '
                             '-fPIC -std=c11 '
 ...
 'PY_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall '
              '--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot '
              '-fPIC '
              '--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot '
              '-fPIC',
 ...
 'PY_CORE_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall '
                   '--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot '
                   '-fPIC '
                   '--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot '
                   '-fPIC -std=c11 -Werror=implicit-function-declaration '
                   ...
                   '-I/root/edl/android-out/edl-android-arm64-full-ossl111/include '
                   '-DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot '
                    '-L/root/edl/android-out/edl-android-arm64-full-ossl111/lib '
                    '--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot '
                    '-L/root/edl/android-out/edl-android-arm64-full-ossl111/lib',
 ...
 'PY_ENABLE_SHARED': 1,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot '
               '-L/root/edl/android-out/edl-android-arm64-full-ossl111/lib '
               '--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot '
               '-L/root/edl/android-out/edl-android-arm64-full-ossl111/lib',
 'PY_LDFLAGS_NODIST': '',
 'PY_LDFLAGS_NOLTO': '--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot '
                     '-L/root/edl/android-out/edl-android-arm64-full-ossl111/lib '
                     '--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot '
                     '-L/root/edl/android-out/edl-android-arm64-full-ossl111/lib',
 ...
 'PY_STDMODULE_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall '
                        '--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot '
                        '-fPIC '
                        '--sysroot=/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/sysroot '
                        '-fPIC -std=c11 -Werror=implicit-function-declaration '
 ...
 'READELF': '/root/my/.ndk/android-ndk-r26d/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-readelf',
 'RESSRCDIR': 'Mac/Resources/framework',
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/root/edl/android-out/edl-android-arm64-full-ossl111/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 'SHLIBS': '-ldl  -lpthread',
 'SHLIB_SUFFIX': '.so',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': '_PYTHON_PROJECT_BASE=/root/edl/android-build-full-ossl111/Python-3.11.8 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/root/edl/android-build-full-ossl111/Python-3.11.8/`cat '
               'pybuilddir.txt`:)./Lib '
               ...
               '/root/edl/android-build-full-ossl111/hostpython/bin/python3',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': '_PYTHON_PROJECT_BASE=/root/edl/android-build-full-ossl111/Python-3.11.8 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/root/edl/android-build-full-ossl111/Python-3.11.8/`cat '
               'pybuilddir.txt`:)./Lib '
 ...
 'VERSION': '3.11',
 'WASM_ASSETS_DIR': './root/edl/android-out/edl-android-arm64-full-ossl111',
 'WASM_STDLIB': './root/edl/android-out/edl-android-arm64-full-ossl111/lib/python3.11/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 0,
 ...
 'abs_builddir': '/root/edl/android-build-full-ossl111/Python-3.11.8',
 'abs_srcdir': '/root/edl/android-build-full-ossl111/Python-3.11.8',
 'datarootdir': '/root/edl/android-out/edl-android-arm64-full-ossl111/share',
 'exec_prefix': '/root/edl/android-out/edl-android-arm64-full-ossl111',
 'prefix': '/root/edl/android-out/edl-android-arm64-full-ossl111',
 'srcdir': '.'}
