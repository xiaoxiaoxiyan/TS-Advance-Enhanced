...
Usage:
    ...
    edl nop [--loader=filename] [--signeddigests=filename] [--debugmode] [--vid=vid] [--pid=pid] [--skipstorageinit] [--portname=portname] [--serial] [--devicemodel=value]
...
Options:
    ...
    --signeddigests=filename           Signed digest table for VIP authentication [default: None]
